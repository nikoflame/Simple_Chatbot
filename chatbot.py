...
def get_response(user_input, user_name):
    ...
    if "sad" in user_input:
        ...
        return f"That's awesome, {user_name}!  Your motivational quote is: Happiness cannot be traveled to, owned, earned, worn or consumed. Happiness is the spiritual experience of living every minute with love, grace, and gratitude. -Denis Waitley.  How else are you feeling?"
